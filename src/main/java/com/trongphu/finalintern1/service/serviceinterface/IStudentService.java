...
public interface IStudentService extends IBaseService<Student, Long, StudentRequestDTO, StudentResponseDTO> {
    Page<StudentResponseDTO> searchPage(String name, String studentCode, String email, LocalDate createdFrom, LocalDate createdTo, PaginationObject paginationObject);
